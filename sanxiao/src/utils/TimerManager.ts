/**
 * Created by HuDe Zheng on 2017/03/14
 * Timer管理器
 */
class TimerManager extends BaseClass {
    ...
    private onEnterFrame():void {
        ...
        for (var i:number = 0; i < this._count; i++) {
            ...
            if (t >= handler.exeTime) {
                ...
                handler.method.apply(handler.methodObj, handler.param);
    ...
    private create(useFrame:boolean, delay:number, repeatCount:number, method:Function, methodObj:any, complateMethod:Function, complateMethodObj:any,param:Array<any> = []):void {
        //参数监测
     ...
     *
     */
    public doTimer(delay:number, repeatCount:number, method:Function, methodObj:any, param:Array<any> = [],complateMethod:Function = null, complateMethodObj:any = null):void {
        this.create(false, delay, repeatCount, method, methodObj, complateMethod, complateMethodObj,param);
    }
