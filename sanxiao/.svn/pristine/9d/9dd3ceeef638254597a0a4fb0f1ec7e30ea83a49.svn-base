...
class BaseScene {
    ...
    public addLayer(layer:egret.DisplayObjectContainer):void {
        if (layer instanceof BaseSpriteLayer) {
            App.StageScaleMode.getStage().addChild(layer);
            this._layers.push(layer);
        }
        else if (layer instanceof BaseEuiLayer) {
            App.StageScaleMode.getUIStage().addChild(layer);
            this._layers.push(layer);
        }
    }
    ...
    public addLayerAt(layer:egret.DisplayObjectContainer, index:number):void {
        if (layer instanceof BaseSpriteLayer) {
            App.StageScaleMode.getStage().addChildAt(layer, index);
            this._layers.push(layer);
        }
        else if (layer instanceof BaseEuiLayer) {
            App.StageScaleMode.getUIStage().addChildAt(layer, index);
            this._layers.push(layer);
        }
    }
    ...
    public removeLayer(layer:egret.DisplayObjectContainer):void {
        if (layer instanceof BaseSpriteLayer) {
            App.StageScaleMode.getStage().removeChild(layer);
            this._layers.splice(this._layers.indexOf(layer), 1);
        }
        else if (layer instanceof BaseEuiLayer) {
            App.StageScaleMode.getUIStage().removeChild(layer);
            this._layers.splice(this._layers.indexOf(layer), 1);
        }
    }
