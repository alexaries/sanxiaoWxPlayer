...
var TimerManager = (function (_super) {
    ...
    TimerManager.prototype.create = function (useFrame, delay, repeatCount, method, methodObj, complateMethod, complateMethodObj, param) {
     ...
     *
     */
    TimerManager.prototype.doTimer = function (delay, repeatCount, method, methodObj, param, complateMethod, complateMethodObj) {
        if (param === void 0) { param = []; }
