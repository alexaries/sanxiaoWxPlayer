 ...
 */
var BaseProxy_Http_Dev = (function () {
    function BaseProxy_Http_Dev() {
    }
    /**
     *  update by sbb
     *  实际数据注释
     ...
     *
     */
    BaseProxy_Http_Dev.createDevData = function () {
        ...
        if (random == 70) {
            ...
            BlocksArr4 = [
                ...
                2001, 2005, 2001, 2320, 2320, 2320, 2320, 2320, 2320,
                2003, 2001, 2002, 2320, 2141, 2141, 2141, 2141, 2141,
                2328, 2004, 2326, 2320, 2141, 2141, 2141, 2141, 2141,
                2005, 2002, 2002, 2320, 2141, 2141, 2001, 2001, 2006
            ];
            //一层
            //第五层 铁丝网成
            BlocksArr5 = [
        ...
        for (var i = 0; i < 9; i++) {
            for (var j = 0; j < 9; j++) {
                var BlocksTestObj = { "Id1": 1002, "Id2": -1, "Id3": -1, "Id4": -1, "Id5": -1, "Id6": -1, "Id7": -1 };
                BlocksTestObj["Id1"] = BlocksArr1[i * 9 + j];
                BlocksTestObj["Id3"] = BlocksArr3[i * 9 + j];
        ...
        for (var i = 0; i < 9; i++) {
            for (var j = 0; j < 9; j++) {
                var BlocksObj = { "Id1": 1002, "Id2": -1, "Id3": -1, "Id4": -1, "Id5": -1, "Id6": -1, "Id7": -1 };
    ...
    return BaseProxy_Http_Dev;
}());
__reflect(BaseProxy_Http_Dev.prototype, "BaseProxy_Http_Dev");
//# sourceMappingURL=BaseProxy_Http_Dev.js.map